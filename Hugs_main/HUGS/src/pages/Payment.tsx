...
export default function Payment() {
  ...
  const handleCardPayment = async () => {
    try {
      ...
      const { data } = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/create-order`, {
      ...
      const options = {
        ...
        handler: async function (response: any) {
          try {
            ...
            await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/api/verify-payment`, {
