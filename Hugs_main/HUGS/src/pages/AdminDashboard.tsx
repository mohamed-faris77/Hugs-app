  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          const activeClientsRes = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/dashboard/active-clients`);
        ...
        try {
          const pendingRes = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/dashboard/pending`);
